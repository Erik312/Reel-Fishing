...
void Game::populateLocations(vector<FishingSpot> &v1){
    ...
    while(!_gameOver){
        ...
        if(player_option == 1){
            ...
            if(fish_rng % 2 == 0){
                ...
                cout << "Type: " << fresh_fish._fishSpecies << endl;
                cout << "Weight: " << fresh_fish._fishWeight << " lbs" << endl;
                cout << "Length: " << fresh_fish._fishLength << " in" << endl;
                cout << "*************************************************" << endl;
